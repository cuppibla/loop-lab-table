...
run this again: both judges score the same booking — the seats are still
counted honestly (people go hungry), while the RATING verdict is delighted.

That split is the whole level.
"""
import asyncio
import json
import os
